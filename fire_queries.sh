...
declare -a arr=("go_gc_duration_seconds"                                                
                ...
                "process_max_fds"                                                            
                "s_open_fds"
                "s_resident_memory_bytes"
                "s_start_time_seconds"
                ...
                "prometheus_remote_storage_queue_highest_sent_timestamp_secons"
                ...
                "prometheus_remote_storage_string_interner_zero_reference_relases_total"
...
for i in "${arr[@]}"
do
   ./oneshot -as-at 2020-07-03T10:14:30Z  -config.file=./docs/configuration/single-process-config.yaml $i
